...
//	파일 다운로드
	...
	public byte[] noticeDtlFileDownload(HttpServletResponse response, @RequestParam String originFileName, @RequestParam String tempFileName) {
